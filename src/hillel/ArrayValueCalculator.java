...
public class ArrayValueCalculator {
    ...
    public  int doCalc (String [][]strings) throws ArraySizeException, NumberFormatException, ArrayDataException,NullPointerException {
        ...
        if (strings == null){
            throw new ArrayDataException("Problem");
        }
        else
